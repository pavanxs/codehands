...
const TOOL_LABELS: Record<string, { invoking: string; invoked: string }> = {
  ...
  fs_readRange: { invoking: "Reading file range…", invoked: "Read file range" },
  fs_search: { invoking: "Searching workspace…", invoked: "Searched workspace" },
  fs_applyPatch: { invoking: "Applying patch…", invoked: "Applied patch" },
  process_start: { invoking: "Starting command…", invoked: "Started command" },
  process_startShell: { invoking: "Starting shell…", invoked: "Started shell" },
  process_run: { invoking: "Running command…", invoked: "Ran command" },
  ...
  repo_snapshot: { invoking: "Inspecting repository…", invoked: "Inspected repository" },
  test_run: { invoking: "Running tests…", invoked: "Ran tests" },
  git_diff_summary: { invoking: "Summarising changes…", invoked: "Summarised changes" },
  agent_start: { invoking: "Starting worker…", invoked: "Started worker" },
  agent_status: { invoking: "Checking worker…", invoked: "Checked worker" },
  agent_results: { invoking: "Collecting worker results…", invoked: "Collected worker results" },
  agent_cancel: { invoking: "Cancelling worker…", invoked: "Cancelled worker" },
  agent_run_many: { invoking: "Starting workers…", invoked: "Started workers" },
